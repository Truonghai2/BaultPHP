...
var EventEmitter$2 = /*@__PURE__*/getDefaultExportFromCjs(eventsExports);
...
BufferWriter._configure = function () {
    ...
    BufferWriter.writeBytesBuffer = util$5.Buffer && util$5.Buffer.prototype instanceof Uint8Array && util$5.Buffer.prototype.set.name === "set"
...
Service.prototype.rpcCall = function rpcCall(method, requestCtor, responseCtor, request, callback) {
    ...
    var self = this;
    if (!callback)
        return util$2.asPromise(rpcCall, self, method, requestCtor, responseCtor, request);
...
function requireUtil () {
	 ...
	 * @namespace
	 */
	var util = util$1.exports = requireMinimal();
...
class ProtobufCodec {
    ...
    encodeEmulationRequest(req) {
        const writer = light.Writer.create();
    ...
    decodeReplies(data) {
        const replies = [];
        const reader = light.Reader.create(new Uint8Array(data));
