...
class BlockRegionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Layout (page.blade.php) dùng page_blocks với region: hero, content, sidebar-left, sidebar
        $defaultRegions = [
            ...
            ['name' => 'hero', 'title' => 'Hero', 'description' => 'Page hero section (one per page)', 'max_blocks' => 5, 'is_active' => true],
            ...
            ['name' => 'homepage-hero', 'title' => 'Homepage Hero (legacy)', 'description' => 'Homepage hero section', 'max_blocks' => 5, 'is_active' => true],
