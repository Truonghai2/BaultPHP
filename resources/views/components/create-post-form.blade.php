<form wire:submit.prevent="save">
    <div class="mb-4">
        ...
        <input type="text" id="title" wire:model="title" placeholder="Tiêu đề bài viết..." class="border p-2 rounded w-full @error('title') border-red-500 @enderror">
    ...
    <div class="mb-4">
        ...
        <textarea id="content" wire:model="content" class="border p-2 rounded w-full @error('content') border-red-500 @enderror" rows="4"></textarea>
