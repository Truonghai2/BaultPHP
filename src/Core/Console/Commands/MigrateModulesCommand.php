...
class MigrateModulesCommand extends BaseCommand
{
     ...
     * @var string
     */
    protected string $signature = 'ddd:migrate {--rollback : Rollback the last database migration} {--refresh : Rollback and re-run all migrations} {--status : Show the status of each migration}';
